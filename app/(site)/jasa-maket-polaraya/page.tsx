...
import {
  ...
  MaketKawasanPembangkitListrikFeaturedProjects,
...
export default function LandingPage() {
  return (
    <>
      <HeroSection
        cta={{ label: "Pesan Sekarang", link: "https://wa.me/6281283647509" }}
      ...
      <div className="bg-gray-100 pt-16">
        ...
        />
        <FeaturedProjectsSection
          heading="Maket Kawasan Pembangkit Listrik"
          featuredProjects={MaketKawasanPembangkitListrikFeaturedProjects}
        />
        <FeaturedProjectsSection
        ...
        />
        <HeadingSection
          heading="Dapatkan Harga Spesial"
          cta={{ label: "Hubungi Kami", href: "https://wa.me/6281283647509" }}
        />
        <FeaturedProjectsSection
