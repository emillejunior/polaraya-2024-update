...
import productImage from "@/public/products/siteplan.jpg"
import {
...
export const metadata: Metadata = pageMeta.maketSiteplan

export default function SitePlanMaquettePage() {
  return (
    <>
      <ProductPageHeader
        heading="Jasa Maket Site Plan / Master Plan Terbaik"
        subheading={ProductSubHeading.maketSiteplan}
        image={productImage}
        slug="Maket Site Plan"
      />
      <div className="bg-gray-100 pt-16">
        ...
        <ProductUSPSection
          productUsps={MaketSiteplanUSP}
          productName="Maket Siteplan/Masterplan"
          productImage={productImage}
          type="Product"
        />
      </div>
      <FormSection text="Pembuatan Maket Siteplan/Masterplan" />
      <div className="py-8">
        <HeadingSection
