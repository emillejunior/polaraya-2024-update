...
import productImage from "@/public/products/smart-interaktif.jpg"
import {
  MaketSmartInteraktifFeaturedProjects,
  MaketSmartInteraktifUSP,
  ProductSubHeading,
...
export const metadata: Metadata = pageMeta.maketSmartInteraktif

export default function MaketSmartInteraktifPage() {
  return (
    <>
      <ProductPageHeader
        heading="Maket Smart Interaktif"
        subheading={ProductSubHeading.maketSmartInteraktif}
        image={productImage}
        slug="Maket Smart Interaktif"
      />
      <div className="bg-gray-100 pt-16">
        <div className="pt-8 pb-24">
          <FeaturedProjectsSection
            featuredProjects={MaketSmartInteraktifFeaturedProjects}
          />
        </div>
        <ProductUSPSection
          productUsps={MaketSmartInteraktifUSP}
          productName="Maket Smart Interaktif"
          productImage={productImage}
          type="Product"
        />
      </div>
      <FormSection text="Pembuatan Maket Smart-Interaktif" />
      <div className="py-8">
        <HeadingSection
